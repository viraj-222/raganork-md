...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/9nEfkh0.jpg Hey {sender}, I'm alive \n Uptime: {uptime} ★彡[ᴠɪʜᴀɴɢᴀ.xx]彡★",
    ...
    BOT_INFO: process.env.BOT_INFO || 'ᴠɪʜᴀɴɢᴀ-md;ᴠɪʜᴀɴɢᴀ.xx;+94752799279;https://i.imgur.com/9nEfkh0.jpg;https://whatsapp.com/channel/0029VadiLoZKWEKueLcrN53f',
    RBG_KEY: process.env.RBG_KEY || '5qUgfembihLFPPRnb3mvSVL9',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "ᴠɪʜᴀɴɢᴀ.xx",
    BOT_NAME: process.env.BOT_NAME || 'ᴠɪʜᴀɴɢᴀ.xx',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ᴠɪʜᴀɴɢᴀ.xx;VIHANGA MD bot;https://i.imgur.com/9nEfkh0.jpg' : process.env.AUDIO_DATA,
